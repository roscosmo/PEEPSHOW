...
| PMC-INPUT-002 | long press and repeat timing | Input/Shell | [[Input_Focus_API_Contract]], [[Shell_Settings_Calibration_Contract]] | button runbook | Partial | START shipping scaffold thresholds validated and promoted to HW6 FW0 knobs: `1000 ms` long, `5000 ms` prep, `9000 ms` warning, `11000 ms` imminent; normal non-START long press/repeat remains pending |
