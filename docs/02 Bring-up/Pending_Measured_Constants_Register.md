...
| PMC-POWER-004 | owner quiesce timeout values | Power/RTOS | [[Subsystem_State_Machines]], [[RTOS_Ownership_and_Queue_Topology]] | START shutdown barrier, sleep/wake telemetry, Tracealyzer/SWO evidence | Partial | FW0 START shutdown prep validates a bounded owner-ACK barrier with required/send/ACK/success/failure masks `0x7e/0x7e/0x7e/0x7e/0x0` and all owner statuses `0x0`; final sleep/STOP timeout values remain pending current and fault-injection evidence |
