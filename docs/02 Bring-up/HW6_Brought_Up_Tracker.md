...
- Status: `owner_lifecycle_v13_usbx_msc_bridge_baseline_passed`; all seven physical owner domains reached
...
- Active FW0 ELF SHA-256: `D3786EDF27391BC8DD88D78CE5634D8D06583AE9F63BA8C8B8F24D2CEC371B09`
...
| 7 - USB, BLE, NFC, installer | partial: NINA-B112 bounded AT handshake and owner-routed `AT&D4`/DSR STOP entry pass; detached USB shutdown passes; CubeMX-generated USBX Device MSC and bounded `thStorage` MSC bridge initialize with correct 1 MiB staging geometry while USB remains parked; BLE data/NFC/power, USB host attach/export/reclaim, resume, and connected USB behavior remain open | communication/USB runbooks | transport, recovery, sessions, NFC, and power proven |
