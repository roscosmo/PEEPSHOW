...
This evidence closes the raw block-level flash adapter checkpoint before FileX/LevelX. It does not assign the final flash region layout, create a filesystem, validate wear leveling, expose USB MSC storage, or validate package installation.
