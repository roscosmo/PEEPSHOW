...
PATHS = {
    "install preflight": (COMMAND + ("PS_HW6_RTOS_RunPackageValidation",),
                          "PS_HW6_ObjectCandidate_CheckSceneSet"),
    "installed launch": (LAUNCH + ("PS_SceneRuntime_EnterStateScene",
                                   "PS_SceneRuntime_EnterObjectSceneSet",
    ...
    "installed scene-set launch": (LAUNCH + ("PS_SceneRuntime_EnterStateScene",
        "PS_SceneRuntime_EnterObjectSceneSet"), "PS_HW6_RTOS_ObjectSceneCheck"),
    "shell PLAY scene-set launch": (PLAY + ("PS_SceneRuntime_EnterStateScene",
        "PS_SceneRuntime_EnterObjectSceneSet"), "PS_HW6_RTOS_ObjectSceneCheck"),
    ...
    "development scene-set launch": (OWNER + ("PS_HW6_RTOS_ObjectService",
        "PS_SceneRuntime_EnterDevelopmentSceneSet", "PS_SceneRuntime_EnterObjectSceneSet"),
    ...
    "multi-scene local transaction": (OWNER + ("PS_HW6_RTOS_HandleRuntimeInput",
        "PS_SceneRuntime_HandleStateSceneInput", "PS_SceneRuntime_HandleStateSceneEventId"),
        "PS_HW6_RTOS_ObjectSceneCheck"),
    "multi-scene local timer": (COMMAND + ("PS_HW6_RTOS_RuntimeStateTimersService",
        "PS_SceneRuntime_HandleStateSceneEvent", "PS_SceneRuntime_HandleStateSceneEventId"),
        "PS_HW6_RTOS_ObjectSceneCheck"),
}
ADMISSION_CALLBACKS = {
