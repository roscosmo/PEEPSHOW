...
strict_1.default.deepEqual((0, placementGeometry_1.primitiveBoundsFromPoints)("filled_circle", { x: 5, y: 5 }, { x: 10, y: 8 }), { x: 5, y: 5, width: 7, height: 7 });
...
strict_1.default.equal((0, placementGeometry_1.isFillableShapeKind)("ellipse"), true);
strict_1.default.equal((0, placementGeometry_1.isFillableShapeKind)("line"), false);
strict_1.default.equal((0, placementGeometry_1.shapeKindWithFill)("ellipse", true), "filled_ellipse");
strict_1.default.equal((0, placementGeometry_1.shapeKindWithFill)("filled_rect", false), "outline_rect");
