...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
static ULONG AppUsbMscSenseNotReadyNoMedium(void)
{
  return UX_DEVICE_CLASS_STORAGE_SENSE_STATUS(UX_SLAVE_CLASS_STORAGE_SENSE_KEY_NOT_READY, 0x3AU, 0x00U);
}
                       ...
                       ULONG number_blocks, ULONG lba, ULONG *media_status)
{
  ...
  status = App_StorageReq_UsbMscRead(lba, number_blocks, (uint8_t *)data_pointer, media_status);
  if (status != TX_SUCCESS)
  {
    *media_status = AppUsbMscSenseNotReadyNoMedium();
    return UX_ERROR;
  }
                        ...
                        ULONG number_blocks, ULONG lba, ULONG *media_status)
{
  ...
  status = App_StorageReq_UsbMscWrite(lba, number_blocks, (uint8_t *)data_pointer, media_status);
  if (status != TX_SUCCESS)
  {
    *media_status = AppUsbMscSenseNotReadyNoMedium();
    return UX_ERROR;
                        ...
                        ULONG lba, ULONG *media_status)
{
  ...
  status = App_StorageReq_UsbMscFlush(lba, number_blocks, media_status);
  if (status != TX_SUCCESS)
  {
    *media_status = AppUsbMscSenseNotReadyNoMedium();
    return UX_ERROR;
                         ...
                         ULONG *media_status)
{
  ...
  status = App_StorageReq_UsbMscStatus(media_id, media_status);
  if (status != TX_SUCCESS)
  {
    *media_status = AppUsbMscSenseNotReadyNoMedium();
    return UX_ERROR;
...
ULONG USBD_STORAGE_GetMediaLastLba(VOID)
{
  ...
  LastLba = App_StorageReq_UsbMscGetMediaLastLba();
...
ULONG USBD_STORAGE_GetMediaBlocklength(VOID)
{
  ...
  MediaBlockLen = App_StorageReq_UsbMscGetMediaBlockLength();
