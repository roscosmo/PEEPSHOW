...
Does not define:
- package data schemas (see `07_package_contract.md`)
...
- Host-side tuning controls must use public-knob request events only.
- Hosts must never apply private knob values directly.
