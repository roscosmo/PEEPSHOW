...
- `qPublicKnobReq` runtime/package boundary -> public-knob validator/service
- owner apply queues/events from public-knob service -> owning thread

Exact message shapes are defined in `09_interface_control.md`.
