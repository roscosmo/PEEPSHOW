...
Does not define:
- installer transport ownership details (see `19_storage_and_installer_contract.md`)
...
- `PKG_ACTIVE_APPLY_PUBLIC_DEFAULTS`
...
Key events:
- `EV_PACKAGE_SELECTED`
- `EV_PUBKNOB_DEFAULTS_OK`
- `EV_PUBKNOB_DEFAULTS_FAIL`
...
- Public knob defaults must be validated through public-knob service before runtime prepare.
