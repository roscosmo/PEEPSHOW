...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, E5_BOOT_Pin|SD_MODE_Pin|VLT_LCD_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : TMAG5273_INT_Pin */
...
/* USER CODE BEGIN MX_GPIO_Init_2 */
  {
    ...
    gpio_btn.Mode = GPIO_MODE_IT_RISING_FALLING;
    gpio_btn.Pull = GPIO_PULLUP;

    gpio_btn.Pin = BTN_A_Pin;
    HAL_GPIO_Init(BTN_A_GPIO_Port, &gpio_btn);

    gpio_btn.Pin = BTN_B_Pin;
    HAL_GPIO_Init(BTN_B_GPIO_Port, &gpio_btn);

    gpio_btn.Pin = BTN_BOOT_Pin;
    HAL_GPIO_Init(BTN_BOOT_GPIO_Port, &gpio_btn);

    gpio_btn.Pin = BTN_L_Pin | BTN_R_Pin;
