...
printf "recovery wake/general used/wake/write = 0x%x / %u / 0x%x / 0x%x\n", $sm->joystick_wake_probe_status, $sm->joystick_general_call_used, $sm->joystick_general_call_wake_status, $sm->joystick_general_call_status
printf "recovery address target/after/verify = 0x%x / 0x%x / 0x%x\n", $sm->joystick_i2c_address_target, $sm->joystick_i2c_address_after, $sm->joystick_i2c_address_verify_status
