...
if g_ps_hw6_battery_wake_probe.api_version != 1 || g_ps_hw6_battery_wake_probe.configured != 1
  ...
  printf "Use the running autonomous 1234/A-B package after its 2-second reveal. The shell stayed awake in the observed test; do not use it or the AWAKE ONLY development test.\n"
