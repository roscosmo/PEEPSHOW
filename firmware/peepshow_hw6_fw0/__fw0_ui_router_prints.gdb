...
printf "runtime input count/last = %u / %u / %u / 0x%x\n", $rt->runtime_input_event_count, $rt->runtime_input_last_event, $rt->runtime_input_last_button_id, $rt->runtime_input_last_mask
