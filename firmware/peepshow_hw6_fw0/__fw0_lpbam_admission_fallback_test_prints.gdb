...
printf "compile mode/preferred status/guaranteed attempts = %u / 0x%x / %u\n", g_ps_hw6_owner_probe.display_lpbam_compile_mode, g_ps_hw6_owner_probe.display_lpbam_preferred_status, g_ps_hw6_owner_probe.display_lpbam_guaranteed_attempt_count
...
printf "expected: owner api=29 variant=6 compile mode=0 guaranteed attempts=0, requested/selected=2/1, held=1, LPBAM ready/active=0/0, STOP2 count increments\n"
