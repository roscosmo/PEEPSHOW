...
printf "runtime class/exec/life/suspend count = %u / %u / %u / %u\n", $rt->runtime_current_class, $rt->runtime_execution, $rt->runtime_lifecycle, $rt->runtime_suspend_count
...
printf "actions: NONE=0 MSC_ENTER=1 MSC_EXIT=2 PKG_INSTALL=3 POWER_SHUT_PREP=4\n"
