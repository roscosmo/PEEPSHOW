...
printf "STOP field threshold X/Y/hysteresis and THR samples = %u / %u / %u / %u\n", $sm->joystick_wake_field_threshold_x_code, $sm->joystick_wake_field_threshold_y_code, $sm->joystick_wake_field_hysteresis_code, $sm->joystick_cordic_threshold_cross_count
