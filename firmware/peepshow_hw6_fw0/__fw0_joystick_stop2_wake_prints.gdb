...
printf "expected omnipolar switch: APIs=61/70/8; neutral remains in STOP2, cardinal movement asserts JOY_INT, IRQ enq=deq with no drops, wake source includes 0x4, primary=3, and one logical activation is delivered\n"
