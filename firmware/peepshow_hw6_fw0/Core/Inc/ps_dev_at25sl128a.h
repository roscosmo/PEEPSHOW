...
typedef struct
{
  ...
  uint32_t write_disable_hal_status;
  uint32_t write_disable_status1;
  ...
  uint32_t erase_retry_count;
  uint32_t erase_retry_write_disable_status;
  uint32_t erase_retry_write_disable_status1;
  uint32_t erase_retry_write_enable_status;
  uint32_t erase_retry_write_enable_status1;
  uint32_t erase_retry_hal_status;
  uint32_t erase_retry_status1;
