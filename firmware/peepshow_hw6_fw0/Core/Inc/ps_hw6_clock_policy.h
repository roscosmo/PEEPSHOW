...
#define PS_HW6_CLOCK_POLICY_API_VERSION (13UL)
...
typedef enum
{
  ...
  PS_HW6_CLOCK_PROFILE_REALTIME_HIGH
} PS_HW6_ClockProfile;

#define PS_HW6_CLOCK_PROFILE_LAST PS_HW6_CLOCK_PROFILE_REALTIME_HIGH
...
#define PS_HW6_CLOCK_CAP_LPBAM_DISPLAY_AUTONOMOUS \
  (1UL << 6)
#define PS_HW6_CLOCK_CAP_AUDIO_MIX_ACTIVE \
  (1UL << 7)
...
extern volatile uint32_t g_ps_hw6_clock_audio_mix_profile_override;
