...
/* Private defines -----------------------------------------------------------*/
#define LCD_1HZ_Pin GPIO_PIN_13
#define LCD_1HZ_GPIO_Port GPIOC
#define PWR_DBG_Pin GPIO_PIN_1
#define PWR_DBG_GPIO_Port GPIOH
...
#define MPU_INT_EXTI_IRQn EXTI14_IRQn
...
#define JOY_INT_Pin GPIO_PIN_11
#define JOY_INT_GPIO_Port GPIOC
#define JOY_INT_EXTI_IRQn EXTI11_IRQn
