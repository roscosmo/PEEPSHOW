...
#define PS_EGG_STATE_LOADER_API_VERSION (18UL)
...
#define PS_EGG_STATE_LOADER_AUDIO_ASSET_MAX \
  PS_TARGET_PROFILE_AUDIO_ASSET_MAX
#define PS_EGG_STATE_LOADER_AUDIO_CUE_MAX \
  PS_TARGET_PROFILE_AUDIO_CUE_MAX
#define PS_EGG_STATE_LOADER_AUDIO_SAMPLE_RATE_HZ \
  PS_TARGET_PROFILE_AUDIO_SAMPLE_RATE_HZ
#define PS_EGG_STATE_LOADER_AUDIO_BLOCK_SAMPLES \
  PS_TARGET_PROFILE_AUDIO_BLOCK_SAMPLES
#define PS_EGG_STATE_LOADER_PACKAGE_SIZE_MAX \
...
#define PS_EGG_STATE_LOADER_AUDIO_SAMPLE_MAX \
  (PS_TARGET_PROFILE_AUDIO_BANK_MAX_BYTES * 2UL)
