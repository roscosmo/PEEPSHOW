...
#define PS_INPUT_LOGICAL_API_VERSION (2UL)
...
typedef enum
{
  ...
  PS_INPUT_LOGICAL_SOURCE_JOY_UP_LEFT = 10,
  PS_INPUT_LOGICAL_SOURCE_JOY_UP_RIGHT = 11,
  PS_INPUT_LOGICAL_SOURCE_JOY_DOWN_LEFT = 12,
  PS_INPUT_LOGICAL_SOURCE_JOY_DOWN_RIGHT = 13
