...
printf "expected review: owner api=70 session/valid/transform=1/1/1 coverage=0xf, resolved direction is zero or exactly one bit, review count advances, STOP2 entry count remains unchanged while calibration is open\n"
