...
printf "On INPUT PROOF, use controls naturally: B press/release, hold L, hold R, joystick left/right, hold joystick up/down, and diagonals. The marker should move to the matching labeled position. A returns to the source scene.\n"
printf "For the authored shell-exit proof, return to INPUT PROOF and press START once whenever ready. It must end the package and open the PeepOS shell root. START is package-authored in this diagnostic; no system gesture is defined.\n"
