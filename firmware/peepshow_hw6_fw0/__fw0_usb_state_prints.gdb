...
printf "USB availability state/event/update/tick = %lu / %lu / %lu / %lu\n", g_ps_hw6_owner_sm_probe.usb_host_availability_state, g_ps_hw6_owner_sm_probe.usb_host_availability_event, g_ps_hw6_owner_sm_probe.usb_host_availability_update_count, g_ps_hw6_owner_sm_probe.usb_host_availability_tick
printf "USB availability ext/data/avail/active = %lu / %lu / %lu / %lu\n", g_ps_hw6_owner_sm_probe.usb_host_external_power_present, g_ps_hw6_owner_sm_probe.usb_host_data_seen, g_ps_hw6_owner_sm_probe.usb_host_msc_available, g_ps_hw6_owner_sm_probe.usb_host_msc_active
printf "USB availability pmic/mcu/agree bridge/cmd = %lu / %lu / %lu / %lu / %lu\n", g_ps_hw6_owner_sm_probe.usb_host_pmic_vbus, g_ps_hw6_owner_sm_probe.usb_host_mcu_vbus, g_ps_hw6_owner_sm_probe.usb_host_power_agree, g_ps_hw6_owner_sm_probe.usb_host_bridge_activate_count, g_ps_hw6_owner_sm_probe.usb_host_bridge_command_count
...
printf "rtos stack bytes P/ST = %lu / %lu\n", g_ps_hw6_rtos_probe.thread_stack_config_bytes[0], g_ps_hw6_rtos_probe.thread_stack_config_bytes[5]
printf "rtos stack size P/ST  = %lu / %lu\n", g_ps_hw6_rtos_probe.thread_stack_size[0], g_ps_hw6_rtos_probe.thread_stack_size[5]
printf "rtos stack span P     = 0x%lx - 0x%lx\n", g_ps_hw6_rtos_probe.thread_stack_start[0], g_ps_hw6_rtos_probe.thread_stack_end[0]
printf "rtos stack ptr/high P = 0x%lx / 0x%lx\n", g_ps_hw6_rtos_probe.thread_stack_ptr[0], g_ps_hw6_rtos_probe.thread_stack_highest_ptr[0]
printf "rtos stack span ST    = 0x%lx - 0x%lx\n", g_ps_hw6_rtos_probe.thread_stack_start[5], g_ps_hw6_rtos_probe.thread_stack_end[5]
printf "rtos stack ptr/high ST= 0x%lx / 0x%lx\n", g_ps_hw6_rtos_probe.thread_stack_ptr[5], g_ps_hw6_rtos_probe.thread_stack_highest_ptr[5]
...
printf "staging rescan count/tick/dirty/force/pending = %lu / %lu / %lu / %lu / %lu\n", g_ps_hw6_owner_sm_probe.usb_stage_rescan_request_count, g_ps_hw6_owner_sm_probe.usb_stage_rescan_start_tick, g_ps_hw6_owner_sm_probe.usb_stage_rescan_dirty_seen, g_ps_hw6_owner_sm_probe.usb_stage_rescan_forced, g_ps_hw6_owner_sm_probe.usb_stage_rescan_pending
...
printf "package validate count/tick/status/reason = %lu / %lu / 0x%lx / %lu\n", g_ps_hw6_owner_sm_probe.package_validate_request_count, g_ps_hw6_owner_sm_probe.package_validate_start_tick, g_ps_hw6_owner_sm_probe.package_validate_status, g_ps_hw6_owner_sm_probe.package_validate_reason
printf "package validate pkg/unsup/size/hdr/read = %lu / %lu / %lu / %lu / %lu\n", g_ps_hw6_owner_sm_probe.package_validate_candidate_count, g_ps_hw6_owner_sm_probe.package_validate_unsupported_count, g_ps_hw6_owner_sm_probe.package_validate_file_size, g_ps_hw6_owner_sm_probe.package_validate_header_bytes, g_ps_hw6_owner_sm_probe.package_validate_bytes_read
printf "package validate magic/valid/min/layout = 0x%lx / %lu / %lu / %lu\n", g_ps_hw6_owner_sm_probe.package_validate_magic, g_ps_hw6_owner_sm_probe.package_validate_magic_valid, g_ps_hw6_owner_sm_probe.package_validate_minimum_envelope_valid, g_ps_hw6_owner_sm_probe.package_validate_header_layout_supported
printf "package validate lx/fx/file open/read/close fx/lx close = 0x%lx / 0x%lx / 0x%lx / 0x%lx / 0x%lx / 0x%lx / 0x%lx\n", g_ps_hw6_owner_sm_probe.package_validate_lx_open_status, g_ps_hw6_owner_sm_probe.package_validate_fx_open_status, g_ps_hw6_owner_sm_probe.package_validate_file_open_status, g_ps_hw6_owner_sm_probe.package_validate_file_read_status, g_ps_hw6_owner_sm_probe.package_validate_file_close_status, g_ps_hw6_owner_sm_probe.package_validate_fx_close_status, g_ps_hw6_owner_sm_probe.package_validate_lx_close_status
printf "package validate first16 = %02lx %02lx %02lx %02lx %02lx %02lx %02lx %02lx %02lx %02lx %02lx %02lx %02lx %02lx %02lx %02lx\n", g_ps_hw6_owner_sm_probe.package_validate_header_first16[0], g_ps_hw6_owner_sm_probe.package_validate_header_first16[1], g_ps_hw6_owner_sm_probe.package_validate_header_first16[2], g_ps_hw6_owner_sm_probe.package_validate_header_first16[3], g_ps_hw6_owner_sm_probe.package_validate_header_first16[4], g_ps_hw6_owner_sm_probe.package_validate_header_first16[5], g_ps_hw6_owner_sm_probe.package_validate_header_first16[6], g_ps_hw6_owner_sm_probe.package_validate_header_first16[7], g_ps_hw6_owner_sm_probe.package_validate_header_first16[8], g_ps_hw6_owner_sm_probe.package_validate_header_first16[9], g_ps_hw6_owner_sm_probe.package_validate_header_first16[10], g_ps_hw6_owner_sm_probe.package_validate_header_first16[11], g_ps_hw6_owner_sm_probe.package_validate_header_first16[12], g_ps_hw6_owner_sm_probe.package_validate_header_first16[13], g_ps_hw6_owner_sm_probe.package_validate_header_first16[14], g_ps_hw6_owner_sm_probe.package_validate_header_first16[15]
printf "package pending/install count/tick/class/pkg/unsup/status = %lu / %lu / %lu / %lu / %lu / %lu / 0x%lx\n", g_ps_hw6_owner_sm_probe.package_candidate_pending, g_ps_hw6_owner_sm_probe.package_install_stub_request_count, g_ps_hw6_owner_sm_probe.package_install_stub_start_tick, g_ps_hw6_owner_sm_probe.package_install_stub_candidate_classification, g_ps_hw6_owner_sm_probe.package_install_stub_candidate_count, g_ps_hw6_owner_sm_probe.package_install_stub_unsupported_count, g_ps_hw6_owner_sm_probe.package_install_stub_last_status
printf "staging class: EMPTY=0 UNSUPPORTED=1 PACKAGE_CANDIDATE=2 MULTIPLE=3 ERROR=4; directories are counted but do not block a package candidate; package scan OK=0x0 UNSUPPORTED=0xb NOT_RUN=0xffffffff\n"
